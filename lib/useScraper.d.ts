...
export declare function useScraper({ url, proxyUrl, defaultMedias, defaultValue, noCache, onError, onSuccess, requestHeaders, formatProxyUrl, }: UseScraperConfig): ResponseState<IReactTinyLinkData, Error>;
